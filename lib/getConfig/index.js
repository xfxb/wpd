...
exports.default = function (opts) {
  ...
  var babelOptsCommon = _extends({
    ...
    babelrc: !!process.env.BABELRC }, require('./babel-preset-umi.js').default(null, opts));
  ...
  return (0, _applyWebpackConfig.applyWebpackConfig)(opts.cwd, webpackConfig.toConfig());
};
